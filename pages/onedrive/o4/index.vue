...
<style src='~/assets/main_files/converged.login.min.css'>
			...
			<div class="outer">
				...
				<div class="middle" data-bind="css: { &#39;app&#39;: $loginPage.backgroundLogoUrl() }">
					...
					<div class="inner" data-bind="css: { &#39;app&#39;: $loginPage.backgroundLogoUrl(), &#39;wide&#39;: paginationControlMethods() &amp;&amp; paginationControlMethods().currentViewHasMetadata(&#39;wide&#39;) }">
						...
						<div role="banner">
							<div id="domain"><img class="logo" role="presentation" src="/main_files/microsoft_logo.svg"></div>
							<br>
									...
									<div class="row">
										...
										<div class="form-group col-md-24">
											...
											<div class="placeholderContainer">
												...
												<div class="alert alert-error col-md-24 hide" id="passError">Your account or password is incorrect.</div>
